              ...
              <div className="p-6">
                ...
                <nav className="space-y-1">
                  <button
                    ...
                    className={`w-full flex items-center px-3 py-2 rounded-lg transition-colors ${activeTab === 'profile'
                  ...
                  <button
                    ...
                    className={`w-full flex items-center px-3 py-2 rounded-lg transition-colors ${activeTab === 'wishlist'
                      ? 'bg-blue-900 text-white'
                      : 'text-gray-700 hover:bg-gray-100'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`w-full flex items-center px-3 py-2 rounded-lg transition-colors ${activeTab === 'settings'
                      ? 'bg-blue-900 text-white'
                      : 'text-gray-700 hover:bg-gray-100'
                      }`}
                  >
